...
menu:- nl,nl ,
		...
		write('**                                                                                                  **'), nl,
		write('**                         Descubra qual o caminho mais barato para a sua viagem!                   **'), nl,
		write('**                                                                                                  **'), nl,
		write('******************************************************************************************************'), nl, nl,
		write('**   Menu:'), nl,
		write('**'), nl,
...
resultado:-
    ...
    ((Destino =:= Origem) -> writeln('A origem nao pode ser igual ao destino!');
     ...
     assert(fact(LocalDestino))),
		...
		write('******************************************************************************************************'), nl,
		write('**                                                                                                  **'), nl,
		write('**                             Resultado obtido | Caminho com menor custo:                          **'), nl,
		write('**                                                                                                  **'), nl,
		write('******************************************************************************************************'), nl, nl,nl,

    caminhobarato(LocalOrigem,LocalDestino,Caminho,Custo,Transporte),
